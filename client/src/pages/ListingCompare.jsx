...
function CompareItemTitle({ item, onRemove, onRefresh, refreshing, t, lang }) {
...
function ComparePreviewCard({ item, onRemove, onRefresh, refreshing, priceHint, t }) {
...
function CompareMobileCard({ item, fields, onRemove, onRefresh, refreshing, priceHint, t, lang }) {
...
export default function ListingCompare({ cat }) {
  ...
  usePageMeta({
    ...
    description: config
      ...
      ? t("compare.metaDesc", { category: categoryLabel })
