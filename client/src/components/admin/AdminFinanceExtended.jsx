        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div className="rounded-xl border p-4 bg-slate-50">
              <div className="text-sm text-slate-500">{t("admin.finance.reports.operations")}</div>
      ...
      {data && (
        <>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="rounded-xl border p-4 bg-slate-50">
              <div className="text-sm text-slate-500">{t("admin.finance.promotions.purchasesCount")}</div>
            ...
            <div className="rounded-xl border p-4 bg-white">
              <div className="text-sm text-slate-500">{t("admin.finance.promotions.tariffs")}</div>
