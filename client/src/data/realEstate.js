...
export const DAILY_BALCONY_OPTIONS = ["Есть", "Нет", "Лоджия", "2 балкона"];

export const DAILY_PETS_OPTIONS = ["Можно", "Нельзя", "По договорённости"];

export const DAILY_SMOKING_OPTIONS = ["Можно", "Нельзя", "На балконе"];
