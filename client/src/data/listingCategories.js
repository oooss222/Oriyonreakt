...
const KIDS_GROUPS = buildGroupedCategory([
  ...
  [
    ...
    ["Коляски", "Автокресла", "Велосипеды и самокаты", "Другое"],
  ],
  [
    "Мебель",
  ...
  [
    "Для малышей",
    ["Подгузники и уход", "Кормление", "Питание", "Другое"],
  ],
  [
    "Услуги",
...
const CLOTHING_GROUPS = buildGroupedCategory([
  [
    "Национальная одежда",
    ["Курта", "Чапан", "Атлас и адрас", "Национальные платья", "Костюмы", "Другое"],
  ],
  [
    "Женская",
    [
  ...
  [
    "Аксессуары",
    ["Сумки и рюкзаки", "Головные уборы", "Ремни и кошельки", "Другое"],
  ],
]);
