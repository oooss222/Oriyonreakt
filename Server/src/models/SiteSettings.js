...
Настоящая Политика описывает, какие данные собираются при использовании сайта Diyor.tj, как они обрабатываются и защищаются.

1. Общие положения
- Сайт Diyor.tj предоставляет пользователям возможность размещать и просматривать объявления.
